...
![Snipaste_2025-06-03_16-51-50](src/使用%20github%20写转码笔记教程/Snipaste_2025-06-03_16-51-50.png)

然后会在 Obsidian 右边弹出一个窗口。此时我们在弹出的窗口最上面点击这个按钮：

![Snipaste_2025-06-03_16-53-04](src/使用%20github%20写转码笔记教程/Snipaste_2025-06-03_16-53-04.png)
...
![Snipaste_2025-06-03_17-36-43](src/使用%20github%20写转码笔记教程/Snipaste_2025-06-03_17-36-43.png)
...
> [!WARNING]
> Obsidian 使用的 Markdown 在链接文件的时候，使用的是 Obsidian 自己的连接方式 Wikilink：`[笔记名](笔记名)` ，这和 Github 使用的标准 Markdown 的 Relative Link `[笔记名](./笔记.md)`方式不同。
> 
> 这会导致 README 在 Obsidian 中可以链接到其他笔记，而 Github 中不能。

**解决方法是：**

可以在 `Setting -> Files and Link -> Use [Wikilink](Wikilink)` 中关掉这个选项。
